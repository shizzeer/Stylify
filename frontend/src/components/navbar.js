                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav my-2 my-lg-0">
                            <li className="nav-item active d-md-none"> {/* d-md-none ukrywa element na urządzeniach średnich i większych */}
                                <Link className="nav-link" to="/sell">Sell <span className="sr-only">(current)</span></Link>
                            </li>
                            <li className="nav-item active d-md-none"> {/* d-md-none ukrywa element na urządzeniach średnich i większych */}
                                <Link className="nav-link" onClick={handleLogout}>Logout <span className="sr-only">(current)</span></Link>
                            </li>
                        </ul>
                    </div>
                </div>
